...
abstract class Addons
{
    ...
    public function __construct()
    {
        ...
        // 初始化视图模型
        request()->controller('');  //TP模板的Think驱动从5.0.3开始给模板路径自动加controller信息了，这里要统一把addon的controller设置为空
        //request()->module('');    //TODO:后续可以考虑支持跨addon调用等特性
        //request()->action('');
