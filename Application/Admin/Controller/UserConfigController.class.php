...
class UserConfigController extends AdminController
{
    ...
    public function index()
    {
        ...
        $menu = A('Ucenter/Index')->_tab_menu();
        $default1 = array(array('data-id' => 'disable', 'title' => L('_DISABLE_'), 'items' => $menu), array('data-id' => 'enable', 'title' =>L('_ENABLE_'), 'items' => array()));
...
str;
        ...
        $admin_config->title(L('_USER_CONFIGURATION_'))->data($data)
            ...
            ->keyText('SMS_HTTP', L('_SMS_PLATFORM_HTTP_'), L('_SMS_PLATFORM_HTTP_'))
            ->keyText('SMS_HTTPS', L('_SMS_PLATFORM_HTTPS_'), L('_SMS_PLATFORM_HTTPS_'))
            ...
            ->keyText('SMS_ACCOUNTSID', L('_SMS_ACCOUNTSID_'), L('_SMS_ACCOUNTSID_'))
            ->keyText('SMS_TOKEN', L('_SMS_TOKEN_'), L('_SMS_TOKEN_'))
            ->keyText('SMS_APPID', L('_SMS_APPID_'), L('_SMS_APPID_'))
            ->keyText('SMS_TEMPLATEID', L('_SMS_TEMPLATEID_'), L('_SMS_TEMPLATEID_'))
            ...
            ->group(L('_SMS_CONFIGURATION_'), 'SMS_HTTP,SMS_UID,SMS_PWD,SMS_CONTENT,SMS_HOOK,SMS_RESEND,SMS_HTTP,SMS_HTTPS,SMS_ACCOUNTSID,SMS_TOKEN,SMS_APPID,SMS_TEMPLATEID')
