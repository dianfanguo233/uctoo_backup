...
--
-- 转存表中的数据 `uctoo_action`
--

INSERT INTO `uctoo_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`, `module`) VALUES
...
INSERT INTO `uctoo_action_limit` (`id`, `title`, `name`, `frequency`, `time_number`, `time_unit`, `punish`, `if_message`, `message_content`, `action_list`, `status`, `create_time`, `module`) VALUES
...
DROP TABLE IF EXISTS `uctoo_adv`;
CREATE TABLE IF NOT EXISTS `uctoo_adv` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
DROP TABLE IF EXISTS `uctoo_adv_pos`;
CREATE TABLE IF NOT EXISTS `uctoo_adv_pos` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(50) NOT NULL,
...
--
-- 转存表中的数据 `uctoo_auth_group_access`
--
...
DROP TABLE IF EXISTS `uctoo_checkin`;
CREATE TABLE IF NOT EXISTS `uctoo_checkin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `create_time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
(125, 'MAIL_USER_REG', 5, '注册邮件模板', 3, '', '支持HTML代码', 1388337307, 1389532335, 1, '<a href="http://www.uctoo.com" target="_blank">点击进入</a><span style="color:#E53333;">当您收到这封邮件，表明您已注册成功，以上为您的用户名和密码。。。。祝您生活愉快····</span>', 55),
...
DROP TABLE IF EXISTS `uctoo_district`;
...
INSERT INTO `uctoo_hooks` (`id`, `name`, `description`, `type`, `update_time`, `addons`) VALUES
...
--
-- 表的结构 `uctoo_message_content`
--

DROP TABLE IF EXISTS `uctoo_message_content`;
CREATE TABLE IF NOT EXISTS `uctoo_message_content` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
`uid` int(11) NOT NULL COMMENT '用户ID',
`mp_id` varchar(50) NOT NULL COMMENT '公众号ID',
`type` varchar(10) NOT NULL COMMENT '订单类型，mid微信订单、uid网站订单、api第三方订单',
...
DROP TABLE IF EXISTS `uctoo_report`;
CREATE TABLE IF NOT EXISTS `uctoo_report` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `uctoo_role` (`id`, `group_id`, `name`, `title`, `description`, `user_groups`, `invite`, `audit`, `sort`, `status`, `create_time`, `update_time`) VALUES
(1, 0, 'default', '普通用户', '普通用户', '1', 0, 0, 0, 1, 1452489319, 1452489319),
(2, 0, 'mpfans', '公众号粉丝', '公众号粉丝', '2', '1', '0', '0', '1', '1435036639', '1435039721'),
(3, 0, 'mpop', '公众号管理员', '微信公众号管理员', '1,3', '1', '0', '0', '1', '1426841843', '1427064318');

-- --------------------------------------------------------

--
-- 表的结构 `uctoo_role_config`
--
...
--
-- 表的结构 `uctoo_score_log`
--

DROP TABLE IF EXISTS `uctoo_score_log`;
CREATE TABLE IF NOT EXISTS `uctoo_score_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `ip` bigint(20) NOT NULL,
...
--
-- 转存表中的数据 `uctoo_score_log`
--

INSERT INTO `uctoo_score_log` (`id`, `uid`, `ip`, `type`, `action`, `value`, `finally_value`, `create_time`, `remark`, `model`, `record_id`) VALUES
...
--
-- 转存表中的数据 `uctoo_seo_rule`
--

INSERT INTO `uctoo_seo_rule` (`id`, `title`, `app`, `controller`, `action`, `status`, `seo_keywords`, `seo_description`, `seo_title`, `sort`, `summary`) VALUES
(1000, '整站标题', '', '', '', 1, '', '', '', 7, '-'),
...
-- --------------------------------------------------------
-- ----------------------------
-- Table structure for uctoo_shop_cart
-- ----------------------------
DROP TABLE IF EXISTS `uctoo_shop_cart`;
CREATE TABLE `uctoo_shop_cart` (
...
-- ----------------------------
-- Records of uctoo_shop_cart
-- ----------------------------

-- ----------------------------
-- Table structure for uctoo_shop_coupon
-- ----------------------------
DROP TABLE IF EXISTS `uctoo_shop_coupon`;
CREATE TABLE `uctoo_shop_coupon` (
...
-- ----------------------------
-- Records of uctoo_shop_coupon
-- ----------------------------

-- ----------------------------
-- Table structure for uctoo_shop_delivery
-- ----------------------------
DROP TABLE IF EXISTS `uctoo_shop_delivery`;
CREATE TABLE `uctoo_shop_delivery` (
...
-- ----------------------------
-- Records of uctoo_shop_delivery
-- ----------------------------

-- ----------------------------
-- Table structure for uctoo_shop_messages
-- ----------------------------
DROP TABLE IF EXISTS `uctoo_shop_messages`;
CREATE TABLE `uctoo_shop_messages` (
...
-- ----------------------------
-- Records of uctoo_shop_messages
-- ----------------------------

-- ----------------------------
-- Table structure for uctoo_shop_order
-- ----------------------------
DROP TABLE IF EXISTS `uctoo_shop_order`;
CREATE TABLE `uctoo_shop_order` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '顾客id',
...
-- ----------------------------
-- Table structure for uctoo_shop_product_cats
-- ----------------------------
DROP TABLE IF EXISTS `uctoo_shop_product_cats`;
CREATE TABLE `uctoo_shop_product_cats` (
...
-- ----------------------------
-- Records of uctoo_shop_product_cats
-- ----------------------------

-- ----------------------------
-- Table structure for uctoo_shop_product_comment
-- ----------------------------
DROP TABLE IF EXISTS `uctoo_shop_product_comment`;
CREATE TABLE `uctoo_shop_product_comment` (
...
-- ----------------------------
-- Records of uctoo_shop_product_comment
-- ----------------------------

-- ----------------------------
-- Table structure for uctoo_shop_product_extra_info
-- ----------------------------
DROP TABLE IF EXISTS `uctoo_shop_product_extra_info`;
CREATE TABLE `uctoo_shop_product_extra_info` (
...
-- ----------------------------
-- Records of uctoo_shop_product_extra_info
-- ----------------------------

-- ----------------------------
-- Table structure for uctoo_shop_product_sell
-- ----------------------------
DROP TABLE IF EXISTS `uctoo_shop_product_sell`;
CREATE TABLE `uctoo_shop_product_sell` (
...
-- ----------------------------
-- Records of uctoo_shop_product_sell
-- ----------------------------

-- ----------------------------
-- Table structure for uctoo_shop_slides
-- ----------------------------
DROP TABLE IF EXISTS `uctoo_shop_slides`;
CREATE TABLE `uctoo_shop_slides` (
...
-- ----------------------------
-- Records of uctoo_shop_slides
-- ----------------------------

-- ----------------------------
-- Table structure for uctoo_shop_user_address
-- ----------------------------
DROP TABLE IF EXISTS `uctoo_shop_user_address`;
CREATE TABLE `uctoo_shop_user_address` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '顾客id',
...
-- ----------------------------
-- Records of uctoo_shop_user_address
-- ----------------------------

-- ----------------------------
-- Table structure for uctoo_shop_user_coupon
-- ----------------------------
DROP TABLE IF EXISTS `uctoo_shop_user_coupon`;
CREATE TABLE `uctoo_shop_user_coupon` (
...
-- ----------------------------
-- Records of uctoo_shop_user_coupon
-- ----------------------------
...
--
-- 通用微信支付流水表的结构 `uctoo_transaction`
--
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='通用微信支付流水表';

-- --------------------------------------------------------

--
-- 表的结构 `uctoo_ucenter_admin`
--
...
--
-- 转存表中的数据 `uctoo_ucenter_score_type`
--
...
CREATE TABLE IF NOT EXISTS `uctoo_ucuser` (
  ...
  `last_login_role` INT( 11 ) NOT NULL,
  `show_role` INT( 11 ) NOT NULL COMMENT  '个人主页显示角色',
  `tagid_list` varchar (255) NOT NULL COMMENT '标签id',
  `signature` text NOT NULL,
...
-- --------------------------------------------------------
--
-- 表的结构 `uctoo_ucuser_token`
--

DROP TABLE IF EXISTS `uctoo_ucuser_token`;
CREATE TABLE IF NOT EXISTS `uctoo_ucuser_token` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mid` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `uctoo_user_nav`;
CREATE TABLE IF NOT EXISTS `uctoo_user_nav` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '频道ID',
  `title` char(30) NOT NULL COMMENT '频道标题',
  `url` char(100) NOT NULL COMMENT '频道连接',
  `sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '导航排序',
...
--
-- 转存表中的数据 `uctoo_user_nav`
--

INSERT INTO `uctoo_user_nav` (`id`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`, `color`, `band_color`, `band_text`, `icon`) VALUES
...
--
-- 转存表中的数据 `uctoo_user_role`
--

INSERT INTO `uctoo_user_role` (`id`, `uid`, `role_id`, `status`, `step`, `init`) VALUES
(1, 1, 1, 1, 'finish', 1);
...
DROP TABLE IF EXISTS `uctoo_version`;
CREATE TABLE IF NOT EXISTS `uctoo_version` (
