...
(172, '主题管理', 105, 0, 'Theme/tpls', 1, '', '云市场', 0, ''),
(173, '使用主题', 105, 0, 'Theme/setTheme', 1, '', '云市场', 0, ''),
(174, '查看主题', 105, 0, 'Theme/lookTheme', 1, '', '云市场', 0, ''),
(175, '主题打包下载', 105, 0, 'Theme/packageDownload', 1, '', '云市场', 0, ''),
(176, '卸载删除主题', 105, 0, 'Theme/delete', 1, '', '云市场', 0, ''),
(177, '上传安装主题', 105, 0, 'Theme/add', 1, '', '云市场', 0, ''),
(1000, '基础设置', 0, 0, 'Mpbase/index', 1, '', '', 0, ''),
(1001, '编辑公众号', 1000, 0, 'Mpbase/editMp', 1, '', '公众号', 0, ''),
(1002, '公众号管理', 1000, 0, 'Mpbase/index', 0, '', '公众号', 0, ''),
(1003, '管理基本设置', 1000, 0, 'Mpbase/config', 1, '', '公众号', 0, ''),
(1004, '编辑自定义菜单', 1000, 0, 'Admin/Custommenu/add', 1, '', '公众号', 0, ''),
(1005, '自定义菜单管理', 1000, 2, 'Admin/Custommenu/index', 0, '', '公众号', 0, ''),
(1006, '自定义菜单操作', 1000, 0, 'Admin/Custommenu/operate', 1, '', '公众号', 0, ''),
(1007, '关键词管理', 1000, 3, 'Keyword/index', 0, '', '公众号', 0, ''),
(1008, '切换公众号', 1000, 0, 'Mpbase/change', 1, '', '公众号', 0, ''),
(1009, '删除公众号', 1000, 0, 'Mpbase/del', 1, '', '公众号', 0, ''),
(1010, '微场景', 1000, 20, 'Admin/Weicja/index', 0, '', '公众号', 0, ''),
(1011, '微会员', 0, 0, 'Ucuser/index', 1, '', '', 0, ''),
(1012, '微会员信息', 1011, 0, 'Ucuser/index', 0, '', '微会员管理', 0, ''),
(1013, '系统信息', 74, 10, 'System/index', 0, '', '系统设置', 0, ''),
(1014, '自动回复管理', 1000, 4, 'Mpbase/autoreply', 0, '', '公众号', 0, ''),
(1015, '微会员配置', 1011, 0, 'Ucuser/config', 0, '', '微会员管理', 0, ''),
(1016, '模板消息', 1000, 10, 'Tplmsg/index', 0, '', '公众号', 0, ''),
(1017, '编辑模板消息', 1000, 0, 'Tplmsg/edit', 1, '', '公众号', 0, ''),
