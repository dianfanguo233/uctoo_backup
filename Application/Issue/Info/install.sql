...
CREATE TABLE IF NOT EXISTS `uctoo_issue` (
...
INSERT INTO `uctoo_issue` (`id`, `title`, `create_time`, `update_time`, `status`, `allow_post`, `pid`, `sort`) VALUES
...
--
-- 表的结构 `uctoo_issue_content`
--

CREATE TABLE IF NOT EXISTS `uctoo_issue_content` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
