...
INSERT INTO `uctoo_attribute` (`name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'keyword_type', '关键词类型', 'tinyint(2) NOT NULL', 'bool', '1', '', '0', '0:完全匹配\r\n1:左边匹配\r\n2:右边匹配\r\n3:模糊匹配', '', '0', '1', '1406322885', '1399762861', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'Token', 'token', 'varchar(255) NOT NULL', 'string', '', '', '0', '', '', '0', '1', '1406330590', '1406330590', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'defaultpic', '默认图片', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', '1', '', '', '0', '1', '1399616968', '1399616968', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'count', '数据条数', 'char(50) NOT NULL', 'select', '10', '', '1', '0:随机\r\n1:一条数据\r\n2:两条数据\r\n3:三条数据\r\n4:四条数据\r\n5:五条数据\r\n6:六条数据\r\n7:七条数据\r\n8:八条数据\r\n9:九条数据\r\n10:10条数据\r\n', '98', '0', '1', '1399616902', '1399616902', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'requesttype', '请求方式', 'tinyint(2) NOT NULL', 'bool', '0', '', '0', '0:Get方式\r\n1:Post方式', '', '0', '1', '1406322918', '1399616461', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'title', '接口标题', 'varchar(255) NOT NULL', 'string', '', '', '1', '', '', '0', '1', '1399616398', '1399616398', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'output_format', '输出格式', 'char(50) NOT NULL', 'select', '2', '', '0', '0:微信XML格式\r\n1:原样数据输出\r\n2:整合平台数据', '', '0', '1', '1406322952', '1399616364', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'apisite', '接口网址', 'varchar(255) NOT NULL', 'string', '', '', '1', '', '', '0', '1', '1399616169', '1399616169', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'priority', '优先级别', 'int(10) UNSIGNED NOT NULL', 'num', '', '数字越大级别越高', '3', '', '', '0', '1', '1406323019', '1399617395', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'parameters', '参数', 'text NOT NULL', 'textarea', '', '', '1', '', '', '0', '1', '1399616607', '1399616607', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'keyword', '关键词', 'varchar(255) NOT NULL', 'string', '', '', '1', '', '', '0', '1', '1399616094', '1399616094', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'isfilter', '是否过滤关键词', 'tinyint(2) NOT NULL', 'bool', '0', '', '1', '0:过滤\r\n1:不过滤', '', '0', '1', '1399763002', '1399763002', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ('type', '类型', 'tinyint(2) NOT NULL', 'bool', '1', '', '0', '0:内置\r\n1:自定义\r\n2:第三方平台', '', '0', '1', '1406323849', '1406318376', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` ( `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'remark', '备注', 'varchar(255) NOT NULL', 'string', '', '', '1', '', '', '0', '1', '1406318926', '1406318926', '', '3', '', 'regex', '', '3', 'function');
INSERT INTO `uctoo_attribute` (`name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES ( 'status', '状态', 'tinyint(2) NOT NULL', 'bool', '0', '', '1', '0:启用\r\n1:禁用', '', '0', '1', '1406319817', '1406319817', '', '3', '', 'regex', '', '3', 'function');

UPDATE `uctoo_attribute` SET model_id= (SELECT MAX(id) FROM `uctoo_model`) WHERE model_id=0;


DELETE from uctoo_third ;
DELETE from uctoo_keyword where addon='Third' and keyword='笑话';
DELETE from uctoo_keyword where addon='Third' and keyword='火车';
DELETE from uctoo_keyword where addon='Third' and keyword='翻译';
DELETE from uctoo_keyword where addon='Third' and keyword='快递';
