(function(){
    ...
    var Main = {
        ...
        attachE: function(){
            ...
            $("span.pro_attr").live("click",function(){
                ...
                var imgUrl = "http://"+host+$(this).attr("path");

                var img1 = new Image();
                img1.src = imgUrl;

                var psObj1 = AlloyImage(img1);

                psObj.add(psObj1 , "正常").replace(psObj);

                $("#mainimg").attr("src",psObj.src);
            });
